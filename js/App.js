...
//const projectId = "6a7df2a99e7e5b61d747";

//Your api secret in ifura.io
//const projectSecret = "e570ee05b046c011836d93e665886514be995c1b3fc4b4e487580df04eefdf8e";

window.CONTRACT = {
  address: "0x6e138701843b4a4Aa512BFfE876F7875cF7AC7e5",
...
async function uploadFileToIpfs() {
  ...
  const pinataApiKey = "6a7df2a99e7e5b61d747";
  const pinataSecretApiKey = "e570ee05b046c011836d93e665886514be995c1b3fc4b4e487580df04eefdf8e";
  ...
  try {
    ...
    if (!response.ok) throw new Error("File upload failed to Pinata");
    const data = await response.json();
...
async function get_ChainID() {
  ...
  switch (a) {
    ...
    // BNB Chain
    case 56:
      window.chainID = "BNB Smart Chain (Mainnet)";
      break;
    case 97:
      window.chainID = "BNB Smart Chain Testnet";
      break;

    // Avalanche
    case 43114:
      window.chainID = "Avalanche C-Chain Mainnet";
      break;
    case 43113:
      window.chainID = "Avalanche Fuji Testnet";
      break;

    // Fantom
    case 250:
      window.chainID = "Fantom Opera Mainnet";
      break;
    case 4002:
      window.chainID = "Fantom Testnet";
      break;

    // Arbitrum
    case 42161:
      window.chainID = "Arbitrum One Mainnet";
      break;
    case 421613:
      window.chainID = "Arbitrum Goerli Testnet";
      break;

    // Optimism
    case 10:
      window.chainID = "Optimism Mainnet";
      break;
    case 420:
      window.chainID = "Optimism Goerli Testnet";
      break;

    default:
      window.chainID = `Unknown Chain ID: ${a}`;
      break;
  }
...
async function addExporter() {
  ...
  if (info && address) {
    ...
    $("#note").html(
      `<h5 class="text-center text-warning">You need to provide Address & Name to add  </h5>`
    );
  }
}
...
async function editExporter() {
  ...
  if (info && address) {
    ...
    $("#note").html(
      `<h5 class="text-center text-warning">You need to provide Address & Name to update 😵‍💫 </h5>`
    );
  }
}
